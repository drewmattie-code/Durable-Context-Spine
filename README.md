...
- **ARS** (private/forthcoming): Agent Registry Spine, the system of record layer (for every agentic asset that discovery reads from and governance enforces against).
